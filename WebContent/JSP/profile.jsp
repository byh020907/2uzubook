...
<div id="skipnav"><a href="#maincontent">Skip to main content</a></div>
    ...
    <header>
        <div class="container" id="maincontent" tabindex="-1">
            <div class="row">
                <div class="col-lg-12">
                    <img class="img-responsive" src="../Image/portfolio/profile.png" alt="">
                    <div class="intro-text">
                        <h1 class="name"><c:out value="${param.name}"/></h1>
                        <hr class="star-light">
                        <span class="skills"> ${param.grade}학년 ${param.classroom}반 ${param.number}번 <br> 소프트웨어 개발과 </span>
                    </div>
                </div>
            </div>
        </div>
