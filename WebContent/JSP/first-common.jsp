		...
		<div id="page-wrapper">
		  ...
		  <div id="header">
					...
					<!-- Inner -->
						<div class="inner">
							<header>
								<h1><a href="index.jsp" id="logo">1학년 - 공통과 </a></h1>
							</header>
						</div>
						...
						<div class="row 200%">
							<div class="8u 12u(mobile)" id="content">
								<article id="main">
									<header>
										<h2><a href="#">공통과</a></h2>
										<p>
											 SW인재 육성을 목표로 공통계열로 선발하여 공통 기본교육과정을 운영한 후 2학년부터 전공학과를 선택 후 심화 과정 이수
										</p>
									</header>
									<a href="#" class="image featured"><img src="../Image/student/1.JPG" alt="" /></a>
									<section>
										<header>
										  <h3>1학년 교육 과정 </h3>
										</header>
										<p>
											공통 과목으로 컴퓨터 구조, 자료구조와 알고리즘, JAVA, C언어, 소프트웨어 공학, 운영체제를 배운다.
										</p>
									</section>
									<section>
										<header>
							...
							<div class="4u 12u(mobile)" id="sidebar">
								...
								<section>
									...
									<div class="row 50%">
										<div class="4u">
											<a href="first-fourth-class.html" class="image fit"><img src="../Image/student/student2.png" alt="" /></a>
										</div>
										<div class="8u">
											 <blockquote>
										    <h3>1학년 4반 Resume</h3>
