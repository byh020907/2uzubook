...
<html>
	<head>
		<title>ThirdGrade-Embeded</title>
		<meta charset="utf-8" />
		...
		<div id="page-wrapper">
		  ...
		  <div id="header">
					...
					<!-- Inner -->
						<div class="inner">
							<header>
								<h1><a href="index.jsp" id="logo">3학년 - 임베디드과 </a></h1>
							</header>
						</div>
					...
					<div class="container">
						<div class="row 200%">
							<div class="8u 12u(mobile)" id="content">
								<article id="main">
									<header>
										<h2><a href="#">Embeded Development</a></h2>
										<p>
											SW 및 HW에 대한 기본적인 이해를 바탕으로 임베디드SW 구현을 위한 펌웨어/OS시스템/플랫폼/응용 SW의 개발, 시험, 유지･보수를 수행할 수 있는 임베디드SW 개발자 양성을 목표로 한다.
										</p>
									</header>
									<a href="#" class="image featured"><img src="../Image/student/3.JPG" alt="" /></a>
									<section>
										<header>
										  <h3>3학년 임베디드 개발과 교육 과정 </h3>
										</header>
										<p>
											마이크로프로세스응용, 임베디드 리눅스 프로그래밍, 임베디드 실시간 운영체제, 임베디드 안드로이드 프로그래밍
										</p>
									</section>
									<section>
										<header>
							...
							<div class="4u 12u(mobile)" id="sidebar">
								...
								<section>
									...
									<div class="row 50%">
										<div class="4u">
											<a href="third-third-class.jsp" class="image fit"><img src="../Image/student/student2.png" alt="" /></a>
										</div>
										<div class="8u">
										  <blockquote>
										    <h3>3학년 3반 Resume</h3>
