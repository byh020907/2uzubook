...
<html>
	<head>
		<title>SecondGrade-Software</title>
		<meta charset="utf-8" />
		...
		<div id="page-wrapper">
		  ...
		  <div id="header">
					...
					<!-- Inner -->
						<div class="inner">
							<header>
								<h1><a href="index.jsp" id="logo">2학년 - 소프트웨어 개발과 </a></h1>
							</header>
						</div>
						...
						<div class="row 200%">
							<div class="8u 12u(mobile)" id="content">
								<article id="main">
									...
									<a href="#" class="image featured"><img src="../Image/student/2.JPG" alt="" /></a>
									<section>
										<header>
										  <h3>2학년 소프트웨어 개발과 교육 과정 </h3>
										</header>
										<p>
											JAVA 프로그래밍, C++프로그래밍, DATABASE, 네트워크
										</p>
									</section>
									<section>
										<header>
										...
										<p>
											매주 금요일 각자의 전공 동아리 활동을 통해 선후배들과의 전공 실력을 서로 공유하며, 멘토링을 해서 서로 모르는 것을 채워갑니다. 
										</p>
									</section>
								</article>
							</div>
							<div class="4u 12u(mobile)" id="sidebar">
								...
								<section>
									<header>
										<h3><a href="#">회사는 원하는 인재를 찾을 수 있습니다.</a></h3>
									</header>
									<p>
										학생의 흥미분야, 사용언어, 대회 참여 혹은 수상경력등을 통해 원하는 인재를 고급 검색을 통하여 쉽고 빠르게 찾아서 학생과 접촉 할 수 있습니다!
									</p>
									<footer>
										<a href="search.jsp" class="button">검색 하러 가기</a>
									</footer>
								</section>
								<hr />
								<section>
									<header>
										<h3><a href="#">학생 Resume 보기</a></h3>
									</header>
									<p>
										각 반 학생들이 직접 작성한 자신의 레주메를 볼 수 있습니다!
								  </p>
									<div class="row 50%">
										<div class="4u">
											<a href="second-first-class.jsp" class="image fit"><img src="../Image/student/student2.png" alt="" /></a>
										</div>
										<div class="8u">
										  <blockquote>
										    <h3>2학년 1반 Resume</h3>
									...
									<div class="row 50%">
										<div class="4u">
											<a href="second-second-class.html" class="image fit"><img src="../Image/student/student.png" alt="" /></a>
										</div>
										<div class="8u">
											 <blockquote>
										    <h3>2학년 2반 Resume</h3>
