...
<body class="left-sidebar">
								...
								%>
                            		<div class="4u 12u(mobile)">
                            			<div class="row" id="modal_pop" style="cursor:pointer;">
                            				<div class="5u"><a class="image fit modalLink" onclick="into_modal(this); return false;">
                            					<img src="images/student/etc.png" alt="" /></a>
                            				</div>
                            				<div class="7u">
                            					<h3 class="text-center" id="delete_name"><%=award.get("name")%></h3><%=(Date)award.get("date")%>
                            				</div>
                            			</div>
                            		</div>
                                ...
                                <div class="10u form1">
                                    ...
                                    <form action="" method="post">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label" for="reading_name">책 이름</label>
                                            <input id="name" name="reading_name" placeholder="ex) 이상한 나라의 앨리스" type="text" class="form-control" required> </div>
                                        <div class="form-group">
                                            <label class="control-label" for="reading_startdate">완독 날짜</label>
                                            <input id="date" name="reading_startdate" type="date" class="form-control" required> </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <button onclick="reading_add(); return false;" class="btn btn-primary">추가하기</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
    ...
    var delete_obj;
          	...
          	$.ajax({
				...
				success : function(data) {
					if(data.ret >= 0 && data.ret != null){						
						alert("add_success");
						//성공처리
						var tag_div = '<div class="4u 12u(mobile)"><div class="row" id="modal_pop" style="cursor:pointer;"><div class="5u"><a class="image fit modalLink" onclick="into_modal(this); return false;"><img src="images/student/etc.png" alt="" /></a></div><div class="7u"><h3 class="text-center" id="delete_name">'+name+'</h3>'+date+'</div></div></div></div>';
			        	$("#reading_loc").prepend(tag_div);
			            $("#name").val('');
			            $("#date").val('');
			            $("#keyword").val('');
        ...
        function reading_delete() {
            ...
            console.log(name);
            reading_del(delete_obj,name);
        }

        function reading_del(obj,name) {
