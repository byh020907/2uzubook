	...
	<div id="page-wrapper">
		...
		<div id="header">
			...
			<div class="inner">
				<header>
					<h1>
						<a href="index.html" id="logo">DSM 2UZUBOOK</a>
					</h1>
				</header>
			</div>
			<!-- Nav -->
			...
			<div class="container">
				<div class="row 200%">
					<div class="3u 12u(mobile)" id="sidebar">
						<section>
							<header>
								<h3>
									<a href="#">"세상과 소통하는 게임 개발자"</a>
								</h3>
							</header>
							<p>
								<strong>관심 분야</strong> <br> 게임 개발, C++, 언리얼엔진
							</p>
							...
							<div class="row 50%">
								<div class="4u">
									<a class="image fit"><img src="images/student/license.png"
										alt="" /></a>
								</div>
								<div class="8u">
									<h4><%=(String)licen.get("licenseName") %></h4>
									<p><%=(String)licen.get("licenseDate") %>
									</p>
								</div>
							</div>
							<%} %>
							...
							<div class="row 50%">
								<div class="4u">
									<a class="image fit"><img src="images/student/trophy.png"
										alt="" /></a>
								</div>
								<div class="8u">
									<h4><%=awd.get("awardName") %>
										<br>
										<strong><%=awd.get("award") %></strong>
									</h4>
									<p>
										<%=awd.get("awardDate") %>
									</p>
							...
							<footer>
								<a href="onesee.html" class="button">한눈에 보기</a>
							</footer>
						</section>
					</div>
					<div class="9u 12u(mobile) important(mobile)" id="content">
						<article id="main">
								...
								<%for(int i=0;i<contests.size();i++)
                            {
                            	...
                            	%>
								<strong>⦁<%=contest.get("contestName") %> (<%=contest.get("contestDate") %>)
								</strong> <br> - 의견충돌을 줄이기 위한 토론앱 개발 <br>
								<%} %>
				...
				<div class="row">
					<article class="4u 12u(mobile) special">
						...
						<p>
							c++를 통한 다수의 게임 프로젝트 진행 및 개발하였습니다. 처음에는 쉬운 게임만 개발하였지만 이제는 진짜로 게임같은
							게임을 개발을 하고 있습니다. 깃에 들어가 제 프로젝트를 구경하세요! <br> <a
								href="https://github.com/yjh5424"> <strong>https://github.com/yjh5424</strong>
							</a>
						</p>
					</article>
					<article class="4u 12u(mobile) special">
						<a href="#" class="image featured"><img src="images/club.jpg"
						...
						<p>대덕 sw 마이스터고등학교 최고의 게임 동아리 "Tricks"에서 2년동안 부장을 맡아왔습니다. 우리
							동아리는 c++를 이용한 게임 개발을 1년에 3개를 목표로 하며 여러 공모전을 나가고 있습니다.</p>
					</article>
					<article class="4u 12u(mobile) special">
						<a href="#" class="image featured"><img src="images/hobby.jpg"
							alt="" /></a>
						<header>
							<h3>
								<a href="#">봉사 & 독서</a>
						...
						<p>평소에 책을 즐겨 읽습니다. 가장 좋아하고 추천하고 싶은 책은 데미안. 감명깊게 읽고 삶의 교훈이 많은 책
							입니다. 봉사 활동도 꾸준히 하여 150시간을 채웠습니다.</p>
					</article>
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="12u">
					...
					<section class="contact">
						<header>
							<h3>저와 함께 개발을 하고 싶거나 궁금한 사항이 있으면 연락주세요</h3>
						</header>
						<p><%=email %></p>
						<ul class="icons">
							<li><a href="https://www.facebook.com"
								class="icon fa-facebook"><span class="label">Facebook</span></a></li>
							<li><a href="https://github.com/yjh5424"
