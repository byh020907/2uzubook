...
<body>
	...
	<center>
		...
		<div class="checks">
			<input type="checkbox" id="ex_chk1" onclick="input_box_value()">
			<label for="ex_chk1">1학년</label> <input type="checkbox" id="ex_chk2"
				onclick="input_box_value()"> <label for="ex_chk2">2학년</label>
			<input type="checkbox" id="ex_chk3" onclick="input_box_value()">
			<label for="ex_chk3">3학년</label> <select id="gender">
				<option>성별</option>
			...
			</select> <select class="language" id="language">
