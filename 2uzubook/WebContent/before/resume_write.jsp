						...
						<div class="modal-body">
							...
							<form action="/2uzubook/resumeInputAction" method="post">
								<img src="../Image/portfolio/Security"
									class="img-responsive img-centered" alt=""> <input
									type="hidden" name="type" value="1" /> <input type="text"
									placeholder="관심분야 1" name="one" /> <input type="text"
									placeholder="관심분야 2" name="two" /> <input type="text"
									placeholder="관심분야 3" name="three" /> <input type="submit"
									value="Submit" />
							</form>
					...
					<div class="col-lg-8 col-lg-offset-2">
						<div class="modal-body">
							...
							<div id="pre_set_license" style="display: none">
								<input type="text" placeholder="자격증 명" mname="licenseName" /> <input
									type="text" placeholder="취득 날짜" name="licenseDate" /> <input
									type="text" placeholder="점수 (어학 관련만)" name="jumsu" /> <input
									type="button" value="삭제"
									onclick="remove_item('license_field',this)" /><br>
							</div>
							<hr class="star-primary">
							...
							<form action="/2uzubook/resumeInputAction" method="post">
								<div id="licence_div">
									...
									<ul id="ul_licence">
										<li>
											<div id="license_field"></div>

										</li>
									</ul>
									<input type="button" value="추가"
										onclick="add_item('pre_set_license','license_field')" /> <input
					...
					<div class="col-lg-8 col-lg-offset-2">
						<div class="modal-body">
							...
							<div id="pre_set_conference" style="display: none">
								<input type="text" placeholder="컨퍼런스 명" name="conference" /> <input
									type="text" placeholder="참여 날짜" name="conferenceDate" /> <input
									type="button" value="삭제"
									onclick="remove_item('conference_field',this)" /><br>
							</div>
							<hr class="star-primary">
							...
							<form action="/2uzubook/resumeInputAction" method="post">
								<div id="attend_div">
									...
									<ul id="ul_attend">
										<li>
											<div id="conference_field"></div>
										</li>
									</ul>
									<input type="button" value="추가"
										onclick="add_item('pre_set_conference','conference_field')" />
					...
					<div class="col-lg-8 col-lg-offset-2">
						<div class="modal-body">
							...
							<div id="pre_set_award" style="display: none">
								<input type="text" placeholder="대회명" name="awardName" /> <input
									type="text" placeholder="수상 등급(ex.대상, 금상...)" name="award" />
								<input type="text" placeholder="대회 참여 날짜" name="awardDate" /> <input
									type="button" value="삭제"
									onclick="remove_item('award_field',this)" /><br>
							</div>
							<hr class="star-primary">
							...
							<form action="/2uzubook/resumeInputAction" method="post">
								<div id="award_div">
									...
									<input type="button" value="추가"
										onclick="add_item('pre_set_award','award_field')" /> <input
										type="submit" value="Submit" />
								</div>
							</form>
					...
					<div class="col-lg-8 col-lg-offset-2">
						<div class="modal-body">
							...
							<div id="pre_set_project" style="display: none">
								<input type="text" placeholder="프로젝트 명" name="projectName" /> <input
									type="text" placeholder="프로젝트 시작 날짜(ex.1930/03/02)"
									name="projectStartDate" /> <input type="text"
									placeholder="프로젝트 끝난 날짜(ex.1930/03/02)"
									name="projectFinishDate" /> <input type="text"
									placeholder="프로젝트 간단 설명" name="projectContent" /> <input
									type="button" value="삭제"
									onclick="remove_item('project_field',this)" /><br>
							</div>
							<div id="pre_set_circle" style="display: none">
								<input type="text" placeholder="동아리명" name="circleName" /> <input
									type="text" placeholder="프로젝트 시작 날짜(ex.1930/03/02)"
									name="circleStartDate" /> <input type="text"
									placeholder="프로젝트 끝난 날짜(ex.1930/03/02)" name="circleFinishDate" />
								<input type="text" placeholder="동아리 간단 설명" name="circleContent" />
								<input type="button" value="삭제"
									onclick="remove_item('circle_field',this)" /><br>
							</div>
							<hr class="star-primary">
							...
							<form action="/2uzubook/resumeInputAction" method="post">
								<div id="project_div">
									...
									<input type="button" value="프로젝트 추가"
										onclick="add_item('pre_set_project','project_field')" /> <input
										type="button" value="동아리 추가"
										onclick="add_item('pre_set_circle','circle_field')" /> <input
										type="submit" value="Submit" />
								</div>
							</form>
					...
					<div class="col-lg-8 col-lg-offset-2">
						<div class="modal-body">
							...
							<div id="pre_set_volunteer" style="display: none">
								...
								<input type="button" value="삭제"
									onclick="remove_item('volunteer_field',this)" /><br>
							</div>
							<div id="pre_set_hobby" style="display: none">
								<input type="text" placeholder="취미 1" name="hobbyName" /> <input
									type="text" placeholder="취미 2" name="hobbyName" /> <input
									type="button" value="삭제"
									onclick="remove_item('hobby_field',this)" /><br>
							</div>
							<div id="pre_set_read" style="display: none">
								<input type="text" placeholder="책 명" name="readingName" /> <input
									type="text" placeholder="독서 날짜" name="readingDate" /> <input
									type="button" value="삭제"
									onclick="remove_item('read_field',this)" /><br>
							</div>
							<hr class="star-primary">
							...
							<form action="/2uzubook/resumeInputAction" method="post">
								<div id="etc_div">
									...
									<input type="button" value="봉사 활동 추가"
										onclick="add_item('pre_set_volunteer','volunteer_field')" />
									<input type="button" value="독서 활동 추가"
										onclick="add_item('pre_set_read','read_field')" /> <input
										type="button" value="취미 활동 추가"
										onclick="add_item('pre_set_hobby','hobby_field')" /> <input
										type="submit" value="Submit" />
								</div>
							</form>
