...
<body id="page-top" class="index">
	...
	<header>
		<div class="container" id="maincontent" tabindex="-1">
			<div class="row">
				<div class="col-lg-12">
					<img class="img-responsive" src="../Image/portfolio/profile.png"
						alt="">
					<div class="intro-text">
						...
						<hr class="star-light">
						<span class="skills"> ${param.grade}학년 ${param.classroom}반
							${param.number}번 <br> 소프트웨어 개발과
						</span>
					</div>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-lg-8 col-lg-offset-2">
						<div class="modal-body">
							...
							${param.interest1}<br>${param.interest2} <br>
							${param.interest3} <br>
