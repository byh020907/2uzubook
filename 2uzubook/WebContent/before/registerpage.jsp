		...
		<div class="box1">
			<form action="/2uzubook/joinAction" method="post">
				<input type="text" placeholder="Name" name="name" /> <input
					type="text" placeholder="학번 (ex.10101)" name="student_id" /> <br>
				<select name="gender">
				...
				</select> <input type="text" placeholder="New Id" name="id" /> <input
					type="text" placeholder="New Password" name="password" />
				<p font-size="5px">4~12자의 영문 소문자, 숫자와 특수기호(_)만 사용할 수 있습니다.</p>
				<input type="text" placeholder="Comfirm Password"
					name="comfirm_password" /> <input type="text" placeholder="Email"
					name="email" />
