	...
	<div id="page-wrapper">
							...
							<div id="volunteer_loc" class="row">
								...
								<div class="4u 12u(mobile)">
									<div class="row" id="modal_pop" style="cursor: pointer;">
										<div class="5u">
											<a class="image fit modalLink" onclick="into_modal(this); return false;"> <img
												src="images/student/etc.png" alt="" /></a>
										</div>
										<div class="7u">
								...
								<div class="10u form1">
									...
									<form action="" method="post">
										...
										<div class="form-group">
											<label class="control-label" for="volunteer_name">봉사
												이름</label> <input id="name" name="volunteer_name"
												placeholder="ex) 중랑천 쓰레기 줍기" type="text"
												class="form-control" required>
										</div>
										<div class="form-group">
											<label class="control-label" for="volunteer_cert">봉사
												인증 기관</label> <input id="ins" name="volunteer_cert"
												placeholder="ex) 중랑구청" type="text" class="form-control"
												required>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="col-md-4">
												<button onclick="volunteer_add(); return false;"
        ...
        <div id="modalLayer">
		  <div class="modalContent">
		    ...
		    <button onclick="volunteer_delete(); return false;">삭제</button>
		    </div>
		    </center>
		    <br>
		    <hr>
					...
					.ajax({
						...
						success : function(data) {
							if (data.ret >= 0 && data.ret != null) {
								alert("add_success");
								//성공처리
								var tag_div = '<div class="4u 12u(mobile)"><div class="row" id="modal_pop" style="cursor:pointer;"><div class="5u"><a class="image fit modalLink" onclick="into_modal(this); return false;"><img src="images/student/etc.png"\ alt="" /></a></div><div class="7u"><h3 class="text-center" id="delete_name">'
										+ name
										+ '</h3>'
										+ startdate
										+ '~'
