 ...
 %>
					...
					<li><a href="#">For Student</a>
						<ul>
							...
							%>
							<li><form action="/2uzubook/myresume" method="post"
									id="frm1">
									<a href="#" onClick="go();">내 레주메 보기</a>
								</form></li>
						...
						<div class="9u 12u(mobile) important(mobile)" id="content">
							<article id="main">
								<header>
									...
									<p>자신의 개발 활동을 기록해서 기업에게 보여주세요! 확실하고 솔직하게 자신을 나타낼 수 있도록
										정성스럽게 적어주세요.</p>
								</header>
								...
								<div id="club_loc" class="row">
									...
									<div class="4u 12u(mobile)">
										<div class="row" id="modal_pop" style="cursor: pointer;">
											<div class="5u">
												<a class="image fit" onclick="club_delete(this);"> <img
													src="images/student/circle.png" alt="" /></a>
											</div>
											<div class="7u">
									...
									<div class="10u form1">
										...
										<form action="" method="post">
											...
											<div class="form-group">
												<label class="control-label" for="club_name">동아리 명</label> <input
													id="name" name="club_name" placeholder="ex) NOP "
													type="text" class="form-control" required>
											</div>
											<div class="form-group">
												<label class="control-label" for="club_desc">동아리 설명</label>
												<input id="desc" name="club_desc"
													placeholder="대덕 sw마이스터고등학교 최고의 보안동아리... " type="text"
													class="form-control" required>
											</div>
											<div class="form-group">
												<label class="control-label" for="club_startdate">시작
													날짜</label> <input id="startdate" name="club_startdate" type="date"
													class="form-control" required>
											</div>
											<div class="form-group">
												<label class="control-label" for="club_enddate">종료
													날짜</label> <input id="enddate" name="club_enddate" type="date"
													class="form-control" required>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-md-4">
													<button onclick="club_add(); return false;"
		...
		<script>
						...
						.ajax({
							...
							success : function(data) {
								if (data.ret >= 0 && data.ret != null) {
									alert("add_success");
									//성공처리
									var tag_div = '<div class="4u 12u(mobile)"><div class="row" id="modal_pop" style="cursor:pointer;"><div class="5u"><a class="image fit" onclick="club_delete(this);"><img src="images/student/circle.png" alt="" /></a></div><div class="7u"><h3 class="text-center" id="delete_name">'
											+ name
											+ '</h3>'
											+ startdate
											+ '~'
			...
			function club_delete(obj) {
				...
				var flag = 0;
				var delete_name = $(obj).parent().next(".7u").children(
						"#delete_name");
