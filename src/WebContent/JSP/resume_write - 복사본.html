        ...
        <div class="container" id="maincontent" tabindex="-1">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <button class="btn"><img class="img-responsive" src="../Image/portfolio/plus.png" alt=""></button>
            ...
            <div class="row">
                <div class="col-sm-4 portfolio-item">
                    <a href="#portfolioModal1" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="../Image/portfolio/Interest_area.png" class="img-responsive" alt="Interest"> 
                    </a>
                </div>
                <div class="col-sm-4 portfolio-item">
                    <a href="#portfolioModal2" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="../Image/portfolio/Certificate.png" class="img-responsive" alt="License">
                    </a>
                </div>
                <div class="col-sm-4 portfolio-item">
                    <a href="#portfolioModal3" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="../Image/portfolio/Competition.png" class="img-responsive" alt="Circus tent">
                    </a>
                </div>
                <div class="col-sm-4 portfolio-item">
                    <a href="#portfolioModal4" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="../Image/portfolio/Award.png" class="img-responsive" alt="Game controller">
                    </a>
                </div>
                <div class="col-sm-4 portfolio-item">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-offset-2 col-lg-9">
                  ...
                  <p>⦁제 1회  NYPC 넥슨 청소년 프로그래밍 대회 (2016. 8. 31.) 
                  </p>
                  <p>
                  	⦁대한민국 소프트웨어 융합 해카톤 (2016. 9. 1. ~ 2016. 9. 4.) 
                  </p>
                  <p>
                  	⦁제 1회 충남대학교 동아리 소프트웨어 경진 대회 (2016. 11. 7.) 

                  </p>
                  <p>
                  	⦁엘지 사이언스 과학 UCC (2016. 11. 30.) 
                  </p>
                  <p>
                  	⦁제 1회 교내 꿈 발표 대회(2016. 11. 25) 
                  </p>
                  <p>
                  	⦁DSM 공모전 (2017. 3. 3.)
                  </p>
                    ...
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                           ...
                           <div id="licence_div">
                            	<ul id="ul_licence">
                            		<li>
		                            	<input type="text" placeholder="자격증 명" name="two"/>
		                            	<input type="text" placeholder="취득 날짜" name="two"/>
                    ...
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                           ...
                           <div id="attend_div">
                            	<ul id="ul_attend">
                            		<li>
		                            	<input type="text" placeholder="컨퍼런스 명" name="two"/>
		                            	<input type="text" placeholder="참여 날짜" name="two"/>
                            		</li>
                            	</ul>
                        ...
                        <div class="modal-body">
                           ...
                           <form action="resume_writeAction.jsp" method="post">
	                           <div id="award_div">
	                            	<ul id="ul_award">
	                            		<li>
			                            	<input type="text" placeholder="대회명" name="two"/>
			                            	<input type="text" placeholder="수상 등급(ex.대상, 금상...)" name="two"/>
			                            	<input type="text" placeholder="대회 참여 날짜" name="two"/>
	                            		</li>
	                            	</ul>
                        ...
                        <div class="modal-body">
                            ...
                            <form action="resume_writeAction.jsp" method="post">
	                           <div id="project_div">
	                            	<ul id="ul_project">
	                            		<li>
			                            	<input type="text" placeholder="프로젝트 명" name="two"/>
			                            	<input type="text" placeholder="진행 기간" name="two"/>
			                            	<input type="text" placeholder="프로젝트 간단 설명" name="two"/>
			                 			</li>
			                 			<li>
			                            	<input type="text" placeholder="동아리명" name="two"/>
			                            	<input type="text" placeholder="진행 기간" name="two"/>
			                            	<input type="text" placeholder="동아리 간단 설명" name="two"/>
                        ...
                        <div class="modal-body">
                            ...
                            <form action="resume_writeAction.jsp" method="post">
	                           <div id="etc_div">
	                            	<ul id="ul_etc">
	                            		<li>
			                            	<input type="text" placeholder="봉사활동명" name="two"/>
			                            	<input type="text" placeholder="봉사 활동 날짜" name="two"/>
			                            </li>
			                            <li>
			                            	<input type="text" placeholder="책 명" name="two"/>
			                            	<input type="text" placeholder="독서 날짜" name="two"/>
			                            </li>
			                            <li>
			                            	<input type="text" placeholder="취미 1" name="two"/>
			                            	<input type="text" placeholder="취미 2" name="two"/>
			                            </li>
	                            	</ul>
